    ...
    return this._d({
      home: this._d({
        szymon: this._d({
          ...
          'thesis.md': this._f("# BSc Thesis\n\n## Analysis of Possibilities for Improving RAG Chatbots\n\nGrade: 5.0 (Honors)\nYear: 2025\nUniversity: WAT (Wojskowa Akademia Techniczna)\n\nCode: github.com/Floressek/ImprovedRag\n\nRAG system with corrective retrieval methods,\nevaluating techniques for improving chatbot\naccuracy and reliability.\n\nKey areas explored:\n- Corrective RAG methods and retrieval quality\n- Vector database optimization (Cosmos DB, MongoDB)\n- Embedding strategies and chunking approaches\n- Prompt engineering for better generation\n- Production deployment (Azure, WhatsApp)\n\nRelated project: github.com/Floressek/Azure-db-RAG"),
